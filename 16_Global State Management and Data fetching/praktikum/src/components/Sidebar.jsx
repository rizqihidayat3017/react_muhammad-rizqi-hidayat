        ...
        <aside className="w-64" aria-label="Sidebar">
            <div className="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800 h-screen">
                <ul className="space-y-2">
                    ...
                    <li>
                        <Link to="/aboutApp" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <span className="flex-1 ml-3 whitespace-nowrap">About App</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="/aboutAuthor" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <span className="flex-1 ml-3 whitespace-nowrap">About Author</span>
                        </Link>
                    </li>
                </ul>
            </div>
